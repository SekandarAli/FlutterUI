...
List<PlanetInfo> planetInfo = [
  PlanetInfo(1,
      name: 'Mercury',
      iconImage: Assets.imagesMercury,
      color: Colors.orange,  
      description:
  ...
  PlanetInfo(8,
      name: 'Neptune',
      iconImage: Assets.imagesNeptune,
      color: Colors.brown,
      description:
