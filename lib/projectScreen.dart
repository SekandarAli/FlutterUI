...
import 'package:task_list_app/projects/faceApp/onBoarding/splash.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> FaceSplashScreen()));
                      },
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Colors.black, backgroundColor: Colors.white, // text color
                        side: BorderSide(width: 2, color: Colors.black), // outline border
                      ),
                      child: Text('Face App', style: TextStyle(fontSize: 14.sp)),
                    ),
                  )
                ],
              ),
